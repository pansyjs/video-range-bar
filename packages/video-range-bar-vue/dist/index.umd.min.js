!(function (e, t) {
  ...
  var r = (function () {
    function e(t) {
      ...
      (this.el = O),
        ...
        (this.theme = h),
        (this.background = A),
        (this.startLeftSlider = v),
        (this.startRightSlider = p),
        (this.moveLeftSlider = B),
        (this.moveRightSlider = w),
        this.createTemplate();
      var R = O.querySelector('.video-range-bar-left'),
        E = O.querySelector('.video-range-bar-right'),
        L = O.querySelector('.video-range-bar-content');
      (this.sliderRightBar = E),
  ...
  function o(e, t, i, n, r, o, s, a, d, c) {
    ...
    if (
      ...
      if (f.functional) {
        ...
        f.render = function (t, i) {
          return l.call(i), e(t, i);
        };
      } else {
        const e = f.beforeCreate;
        f.beforeCreate = e ? [].concat(e, l) : [l];
      }
    return i;
  }
  const s = {
  ...
  return (
    (d.install = function (e) {
      ...
      e.component(t.name ? t.name : d.name, d);
    }),
